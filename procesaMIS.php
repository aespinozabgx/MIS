        ...
        for ($cont=0; $cont < $matriz_row; $cont++)
        {
            ...
            for ($i=0; $i < $datosMesPrevio_row; $i++)
            {
                if ($datosMesPrevio[$i]['NOM_PROYECTO'] == $matriz[$cont]['NOM_PROYECTO'])
                {
                    ...
                    $colateralSQL[$cont][0] = $mesActualziar;
                    $colateralSQL[$cont][1] = $matriz[$cont]['COLATERAL'];
                    $colateralSQL[$cont][2] = $matriz[$cont]['CVE_CRE_IF'];
                    $colateralSQL[$cont][3] = $matriz[$cont]['CVE_CRE_ID_OFERTA'];
                    $colateralSQL[$cont][4] = $matriz[$cont]['NUM_REF_SHF'];
                    $colateralSQL[$cont][5] = $matriz[$cont]['NOM_PROYECTO'];
                    $colateralSQL[$cont][6] = $matriz[$cont]['NOM_PROMOTOR'];
                    $colateralSQL[$cont][7] = $matriz[$cont]['TIPO_CREDITO'];
                    $colateralSQL[$cont][8] = $matriz[$cont]['UBICACIÓN_EDO'];
